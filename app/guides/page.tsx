...
export default function GuidesPage() {
  ...
  const manualQuestGuides: GuideEntry[] = [
...

    {
      ...
      slug: 'deciphering-the-data-arc-raiders-quest-guide',
      ...
      need: 'Quest rewards: Defibrillator x3, Trailblazer Grenade x3',

      highlights: [

        'Fuel Control Building (northeast) blue Magnetic Decryptor is the first objective.',

        'Arrival Building top floor hosts the second Decryptor; complete it to finish.',

        'Quest fails on death; move fast across tarmac and avoid sniper sightlines.',
  ...
  return (
    ...
    <div className="relative min-h-screen w-full bg-black text-cyan-50">
      ...
      <div className="relative z-10">
        ...
        <section className="border-b-2 border-cyan-500/30 pt-7 pb-6 md:pt-10 md:pb-8">
          ...
          <div className="container mx-auto max-w-6xl px-4">
            ...
            <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr] items-start">
              ...
              <div className="space-y-4">
                ...
                <div className="inline-flex items-center gap-3 rounded-full border border-cyan-500/30 bg-black/50 px-3.5 py-2 text-[11px] uppercase tracking-[0.08em] text-cyan-200/80 shadow-[0_0_20px_rgba(0,229,255,0.2)]">
                ...
                <h1 className="text-3xl font-bold leading-tight md:text-4xl">
                  ...
                  <span className="bg-gradient-to-r from-cyan-300 via-blue-500 to-cyan-200 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(0,229,255,0.55)]">
                ...
                <p className="text-base text-cyan-100/80 md:text-lg">
                ...
                <div className="flex flex-wrap gap-2.5">
                  ...
                  <Link
                    ...
                    className="rounded-lg bg-cyan-500 px-5 py-3 text-sm font-semibold text-black shadow-[0_0_22px_rgba(0,229,255,0.35)] transition hover:scale-[1.01] hover:shadow-[0_0_30px_rgba(0,229,255,0.6)]"
              ...
              <div className="grid gap-2.5 rounded-2xl border border-cyan-500/30 bg-gradient-to-b from-slate-950/70 via-blue-950/50 to-slate-950/80 p-4 shadow-[0_16px_44px_rgba(0,0,0,0.38)]">
